...
Color settingsPageBackground(BuildContext context) => settingsIsDark(context)
...
Color _settingsMutedText(BuildContext context) => settingsIsDark(context)
...
class SettingsNavigationTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      leading: icon != null ? Icon(icon, color: const Color(0xFF1F8EFA)) : null,
      title: Text(
        title,
